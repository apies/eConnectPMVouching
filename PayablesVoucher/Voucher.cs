...
namespace PayablesVoucher
{
    class Voucher
    {
        ...
        public void PushtoGP(XElement )
        {
        
            eConnectMethods e = new eConnectMethods();
            string employeeUpdate = xemployeeUpdate.ToString();
            ...
            e.eConnect_EntryPoint(sConnectionString, EnumTypes.ConnectionStringType.SqlClient, employeeUpdate, EnumTypes.SchemaValidationType.XSD, sXsdSchema);
    }
}
